...
export const translations = {
    en: {
        ...
        'settings.billing.ccp_name': 'Account holder name',
        'settings.billing.ccp_number': 'CCP Number',
        'settings.billing.ccp_key': 'Key (Clé)',
        'settings.billing.ccp_address': 'Address',
        'settings.billing.baridimob_name': 'Account holder name',
        'settings.billing.baridimob_number': 'Baridimob number',
        'settings.billing.bank': 'Bank',
        'settings.billing.bank_name': 'Bank name',
        'settings.billing.bank_address': 'Branch address',
        'settings.billing.no_payment_info': 'No payment information configured yet. Contact the admin.',
        ...
        'gate.rejected.title': 'Account Rejected',
        'gate.rejected.desc': 'Your account application has been rejected. Please contact our support team for more information.',
        'gate.rejected.contact': 'Contact Support',
        'gate.pending.title': 'Account Under Review',
        'gate.pending.desc': 'Your account is currently being reviewed by our team. You will be notified once it is approved.',
        'gate.pending.hint': 'This usually takes 24–48 hours. Make sure your profile and payment receipt are complete in Settings.',
        'gate.pending.go_settings': 'Go to Settings',
        'gate.no_subscription.title': 'Subscription Required',
        'gate.no_subscription.desc': 'An active subscription is required to access this page. Please go to Settings to choose a pack and upload your payment receipt.',
        'gate.no_subscription.go_settings': 'Go to Settings',
    },
    fr: {
        ...
        'settings.billing.ccp': 'CCP',
        'settings.billing.ccp_name': 'Nom du titulaire',
        'settings.billing.ccp_number': 'Numéro CCP',
        'settings.billing.ccp_key': 'Clé',
        'settings.billing.ccp_address': 'Adresse',
        'settings.billing.baridimob_name': 'Nom du titulaire',
        'settings.billing.baridimob_number': 'Numéro Baridimob',
        'settings.billing.bank': 'Banque',
        'settings.billing.bank_name': 'Nom de la banque',
        'settings.billing.bank_address': 'Adresse de l\'agence',
        'settings.billing.no_payment_info': 'Aucune information de paiement configurée. Contactez l\'admin.',
        ...
        'gate.rejected.title': 'Compte Rejeté',
        'gate.rejected.desc': 'Votre demande de compte a été rejetée. Veuillez contacter notre équipe de support pour plus d\'informations.',
        'gate.rejected.contact': 'Contacter le Support',
        'gate.pending.title': 'Compte en Cours de Vérification',
        'gate.pending.desc': 'Votre compte est en cours d\'examen par notre équipe. Vous serez notifié une fois approuvé.',
        'gate.pending.hint': 'Cela prend généralement 24 à 48 heures. Assurez-vous que votre profil et votre reçu de paiement sont complets dans Paramètres.',
        'gate.pending.go_settings': 'Aller aux Paramètres',
        'gate.no_subscription.title': 'Abonnement Requis',
        'gate.no_subscription.desc': 'Un abonnement actif est requis pour accéder à cette page. Veuillez aller dans Paramètres pour choisir un pack et téléverser votre reçu.',
        'gate.no_subscription.go_settings': 'Aller aux Paramètres',
    },
    ar: {
        ...
        'settings.billing.ccp': 'CCP',
        'settings.billing.ccp_name': 'اسم صاحب الحساب',
        'settings.billing.ccp_number': 'رقم CCP',
        'settings.billing.ccp_key': 'المفتاح (Clé)',
        'settings.billing.ccp_address': 'العنوان',
        'settings.billing.baridimob_name': 'اسم صاحب الحساب',
        'settings.billing.baridimob_number': 'رقم بريدي موب',
        'settings.billing.bank': 'البنك',
        'settings.billing.bank_name': 'اسم البنك',
        'settings.billing.bank_address': 'عنوان الفرع',
        'settings.billing.no_payment_info': 'لم يتم إعداد معلومات الدفع بعد. تواصل مع الإدارة.',
        ...
        'gate.rejected.title': 'الحساب مرفوض',
        'gate.rejected.desc': 'تم رفض طلب حسابك. يرجى التواصل مع فريق الدعم للمزيد من المعلومات.',
        'gate.rejected.contact': 'تواصل مع الدعم',
        'gate.pending.title': 'الحساب قيد المراجعة',
        'gate.pending.desc': 'حسابك حالياً قيد المراجعة من قِبل فريقنا. ستتلقى إشعاراً فور الموافقة عليه.',
        'gate.pending.hint': 'عادةً ما يستغرق هذا 24 إلى 48 ساعة. تأكد من اكتمال ملفك الشخصي وإيصال الدفع في الإعدادات.',
        'gate.pending.go_settings': 'الذهاب إلى الإعدادات',
        'gate.no_subscription.title': 'اشتراك مطلوب',
        'gate.no_subscription.desc': 'يلزم وجود اشتراك نشط للوصول إلى هذه الصفحة. يرجى الذهاب إلى الإعدادات لاختيار باقة ورفع إيصال الدفع.',
        'gate.no_subscription.go_settings': 'الذهاب إلى الإعدادات',
    }
};
